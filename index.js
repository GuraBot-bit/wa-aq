...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:iFall\n'
            + 'ORG:Owner iFall;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6287897650449:+62 878-9765-0449\n'
            + 'END:VCARD'
...
\`\`\`Nomor :\`\`\` ${num.replace('087897650449', '')}
...
${demote}`
	...
	//		if (!mek.key.fromMe) return
      ...
      const totalchat = await Zitsraa.chats.all()
			...
			const ownerNumber = [`${setting.ownerNumber}@087897650449`] // replace this with your number
...
const fakegroup = (teks) => {
			Zitsraa.sendMessage(from, teks, text, {
				quoted: {
					key: {
						fromMe: false,
						participant: `0087897650449`, ...(from ? { remoteJid: "6287897650449-1604595598@g.us" } : {})
					},
					message: {
						conversation: fake
					}
...
const fdocu = { key: { fromMe: false, participant: `0087897650449`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "documentMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": fake, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('media/zitsraa.jpeg')}}}
            


const freply = { key: { fromMe: false, participant: `0087897650449`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": fake, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync(`media/zitsraa.jpeg`)} } }

const ftoko = {
key: {
			fromMe: false,
			participant: `0087897650449`, ...(from ? { remoteJid: "status@broadcast" } : {})
		},
		message: {
			"productMessage": {
				"product": {
				...
				"businessOwnerJid": `0087897650449`
		}
	}
}
        ...
        case 'return':
				...
				case 'tovideo':
					...
					exec(`ffmpeg -i ${anum} ${ran}`, (err) => {
						...
						Zitsraa.sendMessage(from, buffers, video, { quoted: freply, caption: 'DONE...' })
						fs.unlinkSync(ran)
					})
					break
...
break
        ...
        case 'grup':
				...
				case 'pm':
					...
					try {
						num = `${args[0].replace(/ /g, '')}087897650449`
...
*_Tunggu Sebentar.._*`
        ...
        case 'ig':
          if (args.length < 1) return reply('*Masukan Url nya?*')
					anu = await fetchJson(`https://api.zeks.xyz/api/ig?url=${body.slice(4)}&apikey=apivinz`, {method: 'get'})
...
case 'fb':
  if (args.length < 1) return reply('*Masukan Url nya?*')
					anu = await fetchJson(`https://videfikri.com/api/fbdl/?urlfb=${body.slice(4)}`, {method: 'get'})
